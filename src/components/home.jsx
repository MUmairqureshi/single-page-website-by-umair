...
<div>
<div className=' sm:h-440 bg-gradient-to-br from-[#000000] mx-auto  max-md:h-[302px]  content-center  via-[rgb(199,158,55)]     to-[#000000] shrink-0  rounded-full md:h-[402px] xl:h-[340px]  md:w-116   aspect-square    justify-center   md:m-112 '>
<Image src={hero} className=" md:h-[402px] lg:h-[402px] xl:h-[342px]    2xl:h-[602px]     mix-blend-overlay  justify-center   "/>
</div></div>
</div>
    </div>
